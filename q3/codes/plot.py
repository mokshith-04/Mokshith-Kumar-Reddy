...
# Annotate the center of the circle
plt.scatter(0, 0, color='green', s=50)  # Mark the center
plt.annotate('Center (0, 0)', (0, 0), textcoords="offset points", xytext=(10,10), ha='center', fontsize=12, fontweight='bold', color='green')
